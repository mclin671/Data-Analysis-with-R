...
ME <- 1.960 * sqrt((0.0499002*(1-0.0499002))/nrow(us12))
...
#Create data sets for Japan and Korea

japan12 <- atheism %>%
  filter(nationality == "Japan", year == "2012")
korea12 <- atheism %>%
  filter(grepl('Korea', nationality), atheism$year == "2012")

#Run inference
inference(y = response, data = japan12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

inference(y = response, data = korea12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
...
#overlap in inference so no evidence that Spain has seen a change within 95% CI

#or use hypothesis test
es <- subset(atheism, atheism$nationality == "Spain")
inference(y = es$response, x = as.factor(es$year), statistic = "proportion", type = "ht", method = "theoretical", null = 0, alternative = "twosided", success = "atheist", data = es)
```
...
inference(y = response, data = us05, type = "ci", statistic = "proportion", method = "theoretical", success = "atheist")

#or use hypothesis test
us <- atheism %>%
 filter(nationality == "United States")

inference(y = response, x = as.factor(us$year), data = us, statistic = "proportion", type = "ht", method = "theoretical", null = 0, alternative = "twosided", success = "atheist")
```
...
#39 countries surveyed in 2005 and 2012. significance level is equal to error chance in type 1 error
```
